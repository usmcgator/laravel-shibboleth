...
return array(
    ...
    */
    ...
    'authfield'     => env('SHIB_AUTH_FIELD', 'email'),
    /*
    |--------------------------------------------------------------------------
    | Emulate an IdP
    |--------------------------------------------------------------------------
    ...
    'emulate_idp_users' => array(
        'admin' => array( // key is username and password (username: admin, pass: admin)
            'uid'         => 'admin',
    ...
    'user' => [
        ...
        'email'       => env('SHIB_EMAIL_FIELD', 'email'),
